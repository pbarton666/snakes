...
def index(request):
    ...
    for s in snakes:
        ...
        short_filenames_to_render.append(s.web_image_file)
        a=1
    #context={'snakes': objs_to_render, 'ids':ids_to_render}
    context={'snakes': zip(objs_to_render, ids_to_render, species_to_render, filenames_to_render, short_filenames_to_render)}
    return render(request, 'snakes/index.html', context)    
    #return HttpResponse("Hello, world. You're at the  ind
